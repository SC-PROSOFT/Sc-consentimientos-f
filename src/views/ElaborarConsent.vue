...
const paren_acomp = ref({
  select: "",
  items: [
    { value: "01", label: "MADRE" },
    { value: "02", label: "PADRE" },
    { value: "03", label: "HIJO(A)" },
    { value: "04", label: "ESPOSO(A)" },
    { value: "05", label: "HERMANO(A)" },
    { value: "06", label: "TIO(A)" },
    { value: "07", label: "SOBRINO(A)" },
    { value: "08", label: "PRIMO(A)" },
    { value: "09", label: "MADRASTRA" },
    { value: "10", label: "PADRASTRO" },
    { value: "11", label: "AMIGO(A)" },
    { value: "12", label: "ABUELO(A)" },
    { value: "13", label: "NIETO(A)" },
    { value: "14", label: "TRABAJADOR SOCIAL" },
    { value: "15", label: "OTRO" },
  ],
  paren_acomp_form: {
    label: "Parentesco:",
