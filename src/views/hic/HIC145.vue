<template>
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        <div class="text-center">
          ...
          />
          <p :class="opcion_hic145 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hic145 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hic145">
              {{ opcion_hic145 }}
            </q-chip>
          </p>
        </div>
        ...
        <div class="row q-mt-md q-mb-md">
          <div>
            ...
            <p class="text-justify q-pa-xs">
              La septorrinoplastia es una técnica quirúrgica que tiene como finalidad la corrección de la forma externa de la nariz y del septum nasal
              que ocaciona alteración funcional.
            </p>
            <p class="text-justify q-pa-xs">
          ...
          <div>
            ...
            <p class="text-justify q-pa-xs">
              La intervención se realiza a través de unas incisiones que se hacen en el interior de las ventanas de la nariz.
            </p>
            <p class="text-justify q-pa-xs">
              Después, los tejidos blandos se separan cuidadosamente de los cartílagos y huesos adyacentes y se corrigen las estructuras no deseadas.
              Posteriormente, los huesos y los cartílagos se sitúan de tal manera que tomen la forma adecuada para la nariz. Ocasionalmente puede ser
              necesario el uso de injertos de hueso o de cartílago. En el mismo acto quirúrgico se realiza la reconstrucción del tabique nasal, si
              está desviado, para aliviar la dificultad respiratoria que dicha desviación pueda producir.
            </p>
            <p class="text-justify q-pa-xs">
              En la intervención se deja una pequeña férula de yeso u otros materiales sobre el dorso de la nariz y se coloca un taponamiento nasal o
              cánulas de silicona durante unas 72 horas. Por otra parte, como quiera que la valoración del resultado de la intervención, por parte del
              paciente, es subjetiva, cabe la posibilidad de no resultar satisfactoria. Todas estas circunstancias podrían justificar un segundo
              tiempo operatorio unos meses después.
            </p>
            <p class="text-justify q-pa-xs">
          ...
          <div>
            ...
            <ul class="text-justify">
              ...
              <li>
                <p class="text-justify q-pa-xs">Persistencia del defecto previo a pesar de la adecuada corrección quirúrgica.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Sinarquías -bridas entre ambas paredes de las fosas nasales-.</p>
              </li>
              <li>
          ...
          <div class="col-12">
            ...
            <TextArea_ v-model="HIC145.riesgo_personaliz" :field="form.riesgo_personaliz" class="col-12" />
          </div>
          <div>
        ...
        <div v-if="opcion_hic145 == 'AUTORIZAR'">
          ...
          <div class="row">
            <p class="text-justify">
              ...
              <span class="text-bold">SEPTORRINOPLASTIA FUNCIONAL. </span>
            ...
            <Input_ v-model="HIC145.med_explica" :field="form.med_explica" :inputStyle="{ width: '700px' }" />
            <p class="text-justify q-pa-xs">
        ...
        <div v-if="opcion_hic145 == 'REVOCAR'">
        ...
        <span class="text-bold">Villavicencio, {{ HIC145.fecha }}. </span>
      </q-card-section>
    </div>
    <q-separator />
    ...
    <div class="col-12 row justify-center q-my-md">
      <q-btn
        :disable="opcion_hic145 ? false : true"
        @click="validarDatos"
...
import { impresionHIC145, impresion, generarArchivo } from "@/impresiones";
...
const HIC145 = reactive({
  fecha: "",
  med_explica: "",
  riesgo_personaliz: "",
});

const opcion_hic145 = ref(null);
...
onMounted(() => {
  HIC145.fecha = dayjs(getEmpresa.fecha_act).format("YYYY-MM-DD");
  getFirmaProf();
});
...
const grabarConsentimiento = async () => {
  const datos_format = JSON.parse(JSON.stringify(HIC145));
  let datos = {
    nit_entid: nit_usu.value,
    estado: opcion_hic145.value == "AUTORIZAR" ? "1" : "2",
...
const imprimirConsen = async (llave) => {
  try {
    const datos_hic145 = {
      autorizo: opcion_hic145.value == "AUTORIZAR" ? true : false,
      empresa: getEmpresa,
      testigo: getTestigo,
      paciente: getPaci,
      prof: getProf,
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC145" },
      content: impresionHIC145({
        datos: datos_hic145,
      }),
    });
    ...
    const response_impresion = await generarArchivo({ docDefinition: docDefinitionFile, nomb_archivo: `${llave}-HIC-145` });
