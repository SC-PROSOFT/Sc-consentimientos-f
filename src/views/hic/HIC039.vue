...
import { impresionHIC039, impresion, generarArchivo } from "@/impresiones";
...
const imprimirConsen = async (llave) => {
  try {
    ...
    const response_impresion = await generarArchivo({ docDefinition: docDefinitionFile, nomb_archivo: `${llave}-HIC-039` });
