<template>
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        <div class="text-center">
          ...
          />
          <p :class="opcion_hic128 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hic128 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hic128">
              {{ opcion_hic128 }}
            </q-chip>
          </p>
        </div>
        ...
        <div class="row q-mt-md q-mb-md">
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">EN QUE CONSISTE LA TIMPANOPLASTIA</p>
            <p class="text-justify q-pa-xs">
              ...
              paciente (prótesis de teflón o fragmentos de cartílago del pabellón).
            </p>
            <p class="text-justify q-pa-xs">
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">RIESGOS DE LA TIMPANOPLASTIA</p>
            <p class="text-justify q-pa-xs">
            ...
            <ul class="text-justify">
              ...
              <li>
                <p class="text-justify q-pa-xs">
                  ...
                  acufenos después de la intervención.
                </p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
          ...
          <div class="col-12">
            ...
            <TextArea_ v-model="HIC128.riesgo_personaliz" :field="form.riesgo_personaliz" class="col-12" />
          </div>
          <div>
        ...
        <div v-if="opcion_hic128 == 'AUTORIZAR'">
          ...
          <div class="row">
            <p class="text-justify">
              ...
              <span class="text-bold">TIMPANOPLASTIA. </span>
            ...
            <Input_ v-model="HIC128.med_explica" :field="form.med_explica" :inputStyle="{ width: '700px' }" />
            <p class="text-justify q-pa-xs">
        ...
        <div v-if="opcion_hic128 == 'REVOCAR'">
        ...
        <span class="text-bold">Villavicencio, {{ HIC128.fecha }}. </span>
      </q-card-section>
    </div>
    <q-separator />
    ...
    <div class="col-12 row justify-center q-my-md">
      <q-btn
        :disable="opcion_hic128 ? false : true"
        @click="validarDatos"
...
import { impresionHIC128, impresion, generarArchivo } from "@/impresiones";
...
const HIC128 = reactive({
  fecha: "",
  med_explica: "",
  riesgo_personaliz: "",
});

const opcion_hic128 = ref(null);
...
onMounted(() => {
  HIC128.fecha = dayjs(getEmpresa.fecha_act).format("YYYY-MM-DD");
  getFirmaProf();
});
...
const grabarConsentimiento = async () => {
  const datos_format = JSON.parse(JSON.stringify(HIC128));
  let datos = {
    nit_entid: nit_usu.value,
    estado: opcion_hic128.value == "AUTORIZAR" ? "1" : "2",
...
const imprimirConsen = async (llave) => {
  try {
    const datos_hic128 = {
      autorizo: opcion_hic128.value == "AUTORIZAR" ? true : false,
      empresa: getEmpresa,
      testigo: getTestigo,
      paciente: getPaci,
      prof: getProf,
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC128" },
      content: impresionHIC128({
        datos: datos_hic128,
      }),
    });
    ...
    const response_impresion = await generarArchivo({ docDefinition: docDefinitionFile, nomb_archivo: `${llave}-HIC-128` });
