<template>
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        <div class="text-center">
          ...
          />
          <p :class="opcion_hic137 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hic137 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hic137">
              {{ opcion_hic137 }}
            </q-chip>
          </p>
        </div>
        ...
        <div class="row q-mt-md q-mb-md">
          <div>
            ...
            <p class="text-justify q-pa-xs">
              La laringoscopia directa es una forma de exploración de la laringe en la que ésta se valora de una manera directa mediante la
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">
              EN QUE CONSISTE LA LARINGOSCOPIA DIRECTA - MICROCIRUGIA LARÍNGEA
            </p>
            <p class="text-justify q-pa-xs">
              Se trata de un procedimiento diagnóstico en el que se puede, incluso, realizar una toma de biopsia de las zonas que se consideren
              oportunas, o de un procedimiento terapéutico para el tratamiento de diferentes enfermedades de la laringe, tales como pólipos, nódulos,
              o tumores de cuerdas vocales, etc. En este último caso la técnica quirúrgica se denomina microcirugía laríngea. En esta técnica cabe la
              posibilidad de que el cirujano decida la utilización del láser de C02.
            </p>
            <p class="text-justify q-pa-xs">
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">
              RIESGOS DE LA LARINGOSCOPIA DIRECTA -MICROCIRUGIA LARÍNGEA
            </p>
            <p class="text-justify q-pa-xs">
            ...
            <ul class="text-justify">
              <li>
                <p class="text-justify q-pa-xs">Disfonía o alteraciones de la voz.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Disfagia o odinofagia (dificultades y dolor al tragar).</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Estenosis laríngeas o sinequias (bridas que pueden aparecer entre las dos cuerdas vocales).</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
                  Fractura y/o movilización anormal o incluso pérdida de piezas dentarias y heridas en labios y boca.
                </p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Trismus (dificultad para abrir la boca).</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Lesión mandibular o de la articulación de la mandíbula.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Dolor cervical.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
              ...
              <li>
                <p class="text-justify q-pa-xs">
                  Quemaduras en cara o boca e incluso explosión de los gases anestésicos, si se ha utilizado el láser de CO2.
                </p>
              </li>
            </ul>
          ...
          <div class="col-12">
            ...
            <TextArea_ v-model="HIC137.riesgo_personaliz" :field="form.riesgo_personaliz" class="col-12" />
          </div>
          <div>
        ...
        <div v-if="opcion_hic137 == 'AUTORIZAR'">
          ...
          <div class="row">
            <p class="text-justify">
              ...
              <span class="text-bold">LARINGOSCOPIA DIRECTA - MICROCIRUGÍA LARINGEA. </span>
            ...
            <Input_ v-model="HIC137.med_explica" :field="form.med_explica" :inputStyle="{ width: '700px' }" />
            <p class="text-justify q-pa-xs">
        ...
        <div v-if="opcion_hic137 == 'REVOCAR'">
        ...
        <span class="text-bold">Villavicencio, {{ HIC137.fecha }}. </span>
      </q-card-section>
    </div>
    <q-separator />
    ...
    <div class="col-12 row justify-center q-my-md">
      <q-btn
        :disable="opcion_hic137 ? false : true"
        @click="validarDatos"
...
import { impresionHIC137, impresion, generarArchivo } from "@/impresiones";
...
const HIC137 = reactive({
  fecha: "",
  med_explica: "",
  riesgo_personaliz: "",
});

const opcion_hic137 = ref(null);
...
onMounted(() => {
  HIC137.fecha = dayjs(getEmpresa.fecha_act).format("YYYY-MM-DD");
  getFirmaProf();
});
...
const grabarConsentimiento = async () => {
  const datos_format = JSON.parse(JSON.stringify(HIC137));
  let datos = {
    nit_entid: nit_usu.value,
    estado: opcion_hic137.value == "AUTORIZAR" ? "1" : "2",
...
const imprimirConsen = async (llave) => {
  try {
    const datos_hic137 = {
      autorizo: opcion_hic137.value == "AUTORIZAR" ? true : false,
      empresa: getEmpresa,
      testigo: getTestigo,
      paciente: getPaci,
      prof: getProf,
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC137" },
      content: impresionHIC137({
        datos: datos_hic137,
      }),
    });
    ...
    const response_impresion = await generarArchivo({ docDefinition: docDefinitionFile, nomb_archivo: `${llave}-HIC-137` });
