      ...
      <q-form @submit="validarDatos">
        <div class="text-center">
          ...
          <p :class="opcion_hc031 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hc031 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hc031">
              {{ opcion_hc031 }}
            </q-chip>
          </p>
        </div>
        ...
        <div class="row">
          <p class="text-justify">
            Es un examen sencillo del cuello, vagina y vulva, similar a la toma de citología cervicouterina, donde se realiza observación con un
            microscopio especial que permite visualizar los cambios ocurridos en el cuello del útero. Para ayudarnos durante este examen se utilizan
            sustancias que facilitan el reconocimiento de estas lesiones. Cuando el ginecólogo visualiza las lesiones sospechosas procede a tomar una
            muestra pequeña (biopsia) para posteriormente ser analizado por un patólogo. Normalmente puede presentar sangrado y dolor durante el
            procedimiento
          </p>
        </div>
        ...
        <q-list bordered>
          <q-item>
            <q-item-section>
              ...
              <q-item-label>3. Sangrado mínimo durante varios días. Si es moderado se dejará una gasa para retirarla 6 horas después</q-item-label>
        ...
        <div class="row q-mt-md q-mb-md row" v-show="opcion_hc031 == 'REVOCAR'">
          <p>
            ...
            el consentimiento presentado y declaro por tanto que, tras la información recibida, no consiento someterme al procedimiento de
