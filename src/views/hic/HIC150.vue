<template>
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        <div class="text-center">
          ...
          />
          <p :class="opcion_hic150 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hic150 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hic150">
              {{ opcion_hic150 }}
            </q-chip>
          </p>
        </div>
        <div class="row q-mt-md q-mb-md">
          <div>
            ...
            <p class="text-justify q-pa-xs">
              Esta intervención permite la extirpación de la glándula parótida, indicada en situaciones de inflamación crónica o tumores benignos o
              malignos. El tipo de anestesia requerida será la indicada por el anestesiólogo. Es posible que, durante o después de la intervención,
              sea necesaria la utilización de sangre y/o hemoderivados. También es necesario que advierta de posibles alergias medicamentosas,
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">EN QUE CONSISTE LA PAROTIDECTOMIA</p>
            <p class="text-justify q-pa-xs">
              Se lleva a cabo a través de una incisión facial que se disimula justo delante de la oreja, siguiendo por debajo del lóbulo y que se
              prolongo algunos centímetros por el cuello. El nervio facial que transcurre en la proximidad será respetado y diseccionado para efectuar
              una extirpación de la tumoración y del tejido glandular que lo rodea. Dependiendo de los hallazgos anatomopatológicos, la parotidectomía
              puede ser:
            </p>
            <ul class="text-justify">
              <li>
                <p class="text-justify q-pa-xs">Parcial, en coso de que el tumor sea benigno y sin riesgo de recidiva.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
                  Casi total, en el caso de tumor mixto, que es el tipo de tumor benigno más frecuente de la glándula parótida, para evitar el riesgo
                  de recidiva.
                </p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
                  Total, asociado a vaciamiento ganglionar cervical, en caso de tumor maligno. El tratamiento de las cadenas ganglionares cervicales
                  precisa una prolongación de la incisión a nivel cervical.
                </p>
              </li>
            </ul>
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">RIESGOS DE LA PAROTIDECTOMIA</p>
            <p class="text-justify q-pa-xs">
            ...
            <ul class="text-justify">
              <li>
                <p class="text-justify q-pa-xs">La hemorragia en el postoperatorio inmediato, que obliga a una reintervención, es excepcional.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">El hematoma postoperatorio es posible, aunque raras veces de entidad relevante.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
                  Dolor local y alteraciones transitorias de la masticación, debido a la proximidad de la articulación temporomandibular con la zona
                  operada.
                </p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">Dolores cervicales en relación con la postura del cuello durante la intervención.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">La extirpación de la glándula da lugar a una depresión cutánea local.</p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
                  La pérdida de sensibilidad alrededor de la zona anterior de la oreja por donde pasa la incisión cutánea es habitual y disminuye con
                  el tiempo.
                </p>
              </li>
              <li>
                <p class="text-justify q-pa-xs">
                  Parálisis de la cara, de intensidad variable y transitoria, en función de las dificultades quirúrgicas y de la disposición anatómica
                  del nervio facial.
                </p>
              </li>
            </ul>
            ...
            <p class="text-justify q-pa-xs">
              ...
              Durante el año siguiente a la intervención puede presentar una transpiración de la zona operada en el momento de la alimentación
              (Síndrome de Frey). La cicatriz puede quedar sensible o dolorosa por la inflamación local que puede persistir en meses.
            </p>
            <p class="text-justify q-pa-xs">
              <span style="text-decoration: underline">Complicaciones graves y/o excepcionales:</span>
              La parálisis facial definitiva es excepcional. Es debida a una intervención particularmente difícil (tumor sobreinfectado o en caso de
              reintervención) o debido al sacrificio intencionado del nervio facial en caso de que el tumor invada el nervio y sea imprescindible su
              extirpación con el tumor para una resección completa del mismo.
            </p>
            <p class="text-justify q-pa-xs">
          ...
          <div class="col-12">
            ...
            <TextArea_ v-model="HIC150.riesgo_personaliz" :field="form.riesgo_personaliz" class="col-12" />
          </div>
          <div>
        ...
        <div v-if="opcion_hic150 == 'AUTORIZAR'">
          ...
          <div class="row">
            <p class="text-justify">
              ...
              <span class="text-bold">PAROTIDECTOMIA.</span>
            ...
            <Input_ v-model="HIC150.med_explica" :field="form.med_explica" :inputStyle="{ width: '700px' }" />
            <p class="text-justify q-pa-xs">
        ...
        <div v-if="opcion_hic150 == 'REVOCAR'">
        ...
        <span class="text-bold">Villavicencio, {{ HIC150.fecha }}. </span>
      </q-card-section>
    </div>
    <q-separator />
    ...
    <div class="col-12 row justify-center q-my-md">
      <q-btn
        :disable="opcion_hic150 ? false : true"
        @click="validarDatos"
...
import { impresionHIC150, impresion, generarArchivo } from "@/impresiones";
...
const HIC150 = reactive({
  fecha: "",
  med_explica: "",
  riesgo_personaliz: "",
});

const opcion_hic150 = ref(null);
...
onMounted(() => {
  HIC150.fecha = dayjs(getEmpresa.fecha_act).format("YYYY-MM-DD");
  getFirmaProf();
});
...
const grabarConsentimiento = async () => {
  const datos_format = JSON.parse(JSON.stringify(HIC150));
  ...
  const cod_hic = "HIC150";
  const cod_lab = "LAB070"; // Regla LAB = HIC - 80
  let datos = {
    nit_entid: nit_usu.value,
    estado: opcion_hic150.value == "AUTORIZAR" ? "1" : "2",
...
const imprimirConsen = async (llave) => {
  try {
    const datos_hic150 = {
      autorizo: opcion_hic150.value == "AUTORIZAR" ? true : false,
      empresa: getEmpresa,
      testigo: getTestigo,
      paciente: getPaci,
      prof: getProf,
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC150" },
      content: impresionHIC150({
        datos: datos_hic150,
      }),
    });
  ...
  let nomb_consen = getSesion.modulo == "HIC" ? "HIC-150" : "LAB-070";
