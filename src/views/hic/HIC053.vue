      ...
      <q-card-section>
        ...
        <div>
          ...
          <q-list>
            <q-item>
              <q-item-section>
                <q-item-label class="text-bold"> • LA ROPA que se sugiere para el paciente consta de: </q-item-label>
              </q-item-section>
            </q-item>

            <q-item>
              <q-item-section>
                <q-item-label> 2 camisetas sencillas, manga corta. </q-item-label>
              </q-item-section>
            </q-item>

            <q-item>
              <q-item-section>
                <q-item-label>1 camiseta o camisa de manga larga. </q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label> 3 pantalonetas o pantalón largo tipo sudadera.</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label> 3 Interiores. </q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label> 2 brasier (Mujeres). </q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>1 pijama. </q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
          <p style="text-align: justify; padding: 10px">
          ...
          <q-list>
            <q-item>
              <q-item-section>
                <q-item-label class="text-bold">
                  • LOS ÚTILES DE ASEO PERSONAL SON "CONSUMIBLES" PARA 7 DIAS DE HOSPITALIZACIÓN, consta de:
                </q-item-label>
              </q-item-section>
            </q-item>
            ...
            <q-item>
              <q-item-section>
                <q-item-label> 1 cepillo de dientes. </q-item-label>
              </q-item-section>
            </q-item>

            <q-item>
              <q-item-section>
                <q-item-label>1 crema dental mediana. </q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label> 1 barra de jabón de tocador.</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label> 2 rollos de Papel higiénico. </q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>1 toalla de baño. </q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>2 sobres de Shampoo, empaque individual.</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>1 paquete Toallas higiénicas (mujeres).</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>1 prestobarba.</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>2 sobres de desodorante en crema, empaque individual.</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>30 pañales desechables adulto (si el paciente lo requiere).</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                <q-item-label>1 paquete de 100 pañitos húmedos (si el paciente requiere pañal).</q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
          <p style="text-align: justify">
