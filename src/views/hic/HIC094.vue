<template>
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        <div class="text-center">
          ...
          />
          <p :class="opcion_hic094 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hic094 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hic094">
              {{ opcion_hic094 }}
            </q-chip>
          </p>
        </div>
        ...
        <div class="row q-mt-md q-mb-md" style="width: 100%">
          <div style="border: 1px solid #ccc; width: 100%">
            <p class="q-pa-xs" style="text-align: justify">
              ...
              <q-checkbox
                ...
                v-model="HIC094.retiro"
                true-value="S"
                false-value="N"
              />
            </p>

            <p class="q-pa-xs" style="text-align: center; font-weight: bold">IMPLANTE SUBDERMICO</p>
          ...
          <div class="text-justify" style="border: 1px solid #ccc; width: 100%">
            ...
            <ol>
              <li>
                <p class="q-pa-xs" style="text-align: justify">
                  Me han explicado en un lenguaje claro y comprensible la naturaleza y propósito del procedimiento, también me han informado de las Me
                  han explicado en un lenguaje claro y comprensible la naturaleza y propósito del procedimiento, también me han informado de las
                  ventajas, complicaciones, molestias y riesgos que pueden producirse, tales como dolor, equimosis, edema, infeccione en el sitio de
                  la incisión, entre otras.
                </p>
              </li>
              <li>
                <p class="q-pa-xs" style="text-align: justify">
              ...
              <li>
                <p class="q-pa-xs" style="text-align: justify">
                  Se me ha informado plenamente que retirado el implante y al no iniciar inmediatamente otro método de planificación familiar tengo la
              ...
              <li>
                <p class="q-pa-xs" style="text-align: justify">
                  ...
                  como: dolor, moderado a severo, fiebre, sangrado y salida de secreción por el sitio de incisión, escalofríos, entre otras.
                </p>
              </li>
              <li>
        ...
        <div>
          <div v-if="opcion_hic094 == 'REVOCAR'">
            <div class="text-justify" style="border: 1px solid #ccc; width: 100%">
    ...
    <div class="col-12 row justify-center q-my-md">
      <q-btn
        :disable="opcion_hic094 ? false : true"
        @click="validarDatos"
...
import { impresionHIC094, impresion, generarArchivo } from "@/impresiones";
...
const opcion_hic094 = ref(null);
onMounted(() => {
  HIC094.fecha = dayjs(getEmpresa.fecha_act).format("YYYY-MM-DD");
  HIC094.hora = dayjs().format("HH:mm");
  getFirmaProf();
});
...
const grabarConsentimiento = async () => {
  const datos_format = JSON.parse(JSON.stringify(HIC094));
  let datos = {
    nit_entid: nit_usu.value,
    estado: opcion_hic094.value == "AUTORIZAR" ? "1" : "2",
...
const imprimirConsen = async (llave) => {
  try {
    const datos_hic094 = {
      autorizo: opcion_hic094.value == "AUTORIZAR" ? true : false,
      empresa: getEmpresa,
      testigo: getTestigo,
      paciente: getPaci,
      prof: getProf,
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC094" },
      content: impresionHIC094({
        datos: datos_hic094,
      }),
    });
    ...
    const response_impresion = await generarArchivo({ docDefinition: docDefinitionFile, nomb_archivo: `${llave}-HIC-094` });
