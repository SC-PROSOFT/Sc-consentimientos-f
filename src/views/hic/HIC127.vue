<template>
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        <div class="text-center">
          ...
          />
          <p :class="opcion_hic127 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip :color="opcion_hic127 == 'AUTORIZAR' ? 'green' : 'red'" class="text-white" v-if="opcion_hic127">
              {{ opcion_hic127 }}
            </q-chip>
          </p>
        </div>
        ...
        <div class="row q-mt-md q-mb-md">
          <div>
            ...
            <p class="text-justify q-pa-xs">
              ...
              recidivantes del tejido amigdalar o complicaciones cervicales (flemón periamigdalino, flemón faríngeo...).
            </p>
            <p class="text-justify q-pa-xs">
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">EN QUE CONSISTE LA AMIGDALECTOMIA</p>
            <p class="text-justify q-pa-xs">
          ...
          <div>
            <p class="text-left" style="margin-top: 10px; font-weight: bold; margin-left: 10px">RIESGOS DE LA AMIGDALECTOMIA</p>
            <p class="text-justify q-pa-xs">
            ...
            <p class="text-justify q-pa-xs">
              ...
              paladar. Excepcionalmente, es necesario una reeducación del lenguaje (logopedia). No se puede descartar la posibilidad de presentar
              infecciones y otitis después de la intervención, aunque habitualmente la incidenciade infecciones se reduce ostensiblemente.
            </p>
            <p class="text-justify q-pa-xs">
            ...
            <p class="text-justify q-pa-xs">
              ...
              infección cervical son: fiebre alta, dolor de cuello y alteraciones en su movilización. En este caso, acuda al Área de Urgencias para
              valoración.
            </p>
          ...
          <div class="col-12">
            ...
            <TextArea_ v-model="HIC127.riesgo_personaliz" :field="form.riesgo_personaliz" class="col-12" />
          </div>
          <div>
        ...
        <div v-if="opcion_hic127 == 'AUTORIZAR'">
          ...
          <div class="row">
            ...
            <Input_ v-model="HIC127.med_explica" :field="form.med_explica" :inputStyle="{ width: '700px' }" />
            <p class="text-justify q-pa-xs">
        ...
        <div v-if="opcion_hic127 == 'REVOCAR'">
        ...
        <span class="text-bold">Villavicencio, {{ HIC127.fecha }}. </span>
      </q-card-section>
    </div>
    <q-separator />
    ...
    <div class="col-12 row justify-center q-my-md">
      <q-btn
        :disable="opcion_hic127 ? false : true"
        @click="validarDatos"
...
import { impresionHIC127, impresion, generarArchivo } from "@/impresiones";
...
const HIC127 = reactive({
  fecha: "",
  med_explica: "",
  riesgo_personaliz: "",
});

const opcion_hic127 = ref(null);
...
onMounted(() => {
  HIC127.fecha = dayjs(getEmpresa.fecha_act).format("YYYY-MM-DD");
  getFirmaProf();
});
...
const grabarConsentimiento = async () => {
  const datos_format = JSON.parse(JSON.stringify(HIC127));
  let datos = {
    nit_entid: nit_usu.value,
    estado: opcion_hic127.value == "AUTORIZAR" ? "1" : "2",
...
const imprimirConsen = async (llave) => {
  try {
    const datos_hic127 = {
      autorizo: opcion_hic127.value == "AUTORIZAR" ? true : false,
      empresa: getEmpresa,
      testigo: getTestigo,
      paciente: getPaci,
      prof: getProf,
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC127" },
      content: impresionHIC127({
        datos: datos_hic127,
      }),
    });
    ...
    const response_impresion = await generarArchivo({ docDefinition: docDefinitionFile, nomb_archivo: `${llave}-HIC-127` });
