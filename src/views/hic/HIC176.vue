      ...
      <q-card-section>
        ...
        <div class="row justify-between items-center">
          <div class="row">
            ...
            <Input_ class="q-ma-xs" v-model="HIC176.remitente" :field="form.remitente" :inputStyle="{ width: '385px' }" />
          </div>
        ...
        <div class="q-mt-lg">
          ...
          <ol type="a">
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="ABS" v-model="HIC176.result_prb" val="A" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="PC" v-model="HIC176.result_prb" val="B" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Otro" v-model="HIC176.result_prb" val="C" />
            </li>
          </ol>
          <div v-if="HIC176.result_prb == 'C'" class="row">
            <p>Cual:</p>
            <Input_ class="q-ma-xs" v-model="HIC176.otr_result" :field="form.otr_result" :inputStyle="{ width: '385px' }" />
          </div>
        </div>
        <div class="q-mt-lg">
          <div class="col-12">
          ...
          <ol type="a">
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Conducta sexual de riesgo" v-model="HIC176.motivo_prb" val="A" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="DX perinatal" v-model="HIC176.motivo_prb" val="B" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Sospecha clinica" v-model="HIC176.motivo_prb" val="C" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Contacto VIH" v-model="HIC176.motivo_prb" val="D" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Transfusiones antes de 1993" v-model="HIC176.motivo_prb" val="E" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Uso de agujas" v-model="HIC176.motivo_prb" val="F" />
            </li>
            <li>
              <q-radio class="q-ml-xs" color="primary" keep-color label="Tiempo de gestación" v-model="HIC176.motivo_prb" val="G" />
            </li>
          </ol>
        </div>
        <div>
