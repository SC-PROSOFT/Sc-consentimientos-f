  ...
  <q-card class="q-mx-auto format">
    <q-form @submit="validarDatos">
      <q-card-section>
        ...
        <div v-if="HIC173.opcion_hic173 == 'AUTORIZAR'" class="row">
          <p class="text-justify">
        ...
        <div v-if="HIC173.opcion_hic173 == 'REVOCAR'">
          <p class="text-justify">
          ...
          <TextArea_ v-model="HIC173.motivo_revoca" :field="form.motivo_revoca" />
        </div>
        <div class="row">
          <p class="text-justify">
            Este consentimiento informado es asistido <q-radio color="primary" left-label v-model="HIC173.conse_asist" val="S" label="SI" />donde se
            utilizaron acciones como:
          </p>
          <Input_ class="col-xs-12" v-model="HIC173.acciones" :field="form.acciones" />
          <p class="text-justify">
            con el fin de proteger la expresión de la voluntad de la persona con discapacidad. Este consentimiento informado
            <q-radio color="primary" left-label v-model="HIC173.conse_asist" val="N" label="NO" />es asistido.
          </p>
        </div>
...
const datosInit = () => {
  ...
  HIC173.hora = dayjs().format("hh:mm");
};
