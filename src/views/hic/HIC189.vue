  ...
  <q-card class="q-mx-auto format">
    <div>
      <q-card-section>
        ...
        <div v-if="opcion_hic187 == 'AUTORIZAR'">
          ...
          <div class="row">
            ...
            <Input_ v-model="HIC187.med_explica" :field="form.med_explica" :inputStyle="{ width: '700px' }" />
            <p class="text-justify q-pa-xs">
        ...
        <div v-if="opcion_hic187 == 'REVOCAR'">
...
const imprimirConsen = async (llave) => {
  try {
    ...
    const docDefinitionPrint = await utilsFormat({
      datos: { ...firmas, cod_consen: "HIC187" },
    ...
    let nomb_consen = getSesion.modulo == "HIC" ? "HIC-187" : "LAB-092";
