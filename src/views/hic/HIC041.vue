      ...
      <q-card-section>
        <div class="text-center">
          ...
          <p :class="HIC041.opcion_hc041 == 'AUTORIZAR' ? 'text-green' : 'text-red'">
            <q-chip
              :color="HIC041.opcion_hc041 == 'AUTORIZAR' ? 'green' : 'red'"
              class="text-white"
              v-if="HIC041.opcion_hc041"
            >
              {{ HIC041.opcion_hc041 }}
            </q-chip>
          </p>
        ...
        <div class="row" v-show="HIC041.opcion_hc041 == 'REVOCAR'">
          ...
          <Input_
            style="min-width: 100%; display: inline-block"
            v-model="HIC041.revocar_motivos"
