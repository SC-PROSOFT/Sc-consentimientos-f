    ...
    <q-form @submit="validarDatos">
      <q-card-section>
        <div class="text-center">
          ...
          <p
            :class="
              HIC037.opcion_hc037 == 'AUTORIZAR' ? 'text-green' : 'text-red'
            "
          >
            <q-chip
              :color="HIC037.opcion_hc037 == 'AUTORIZAR' ? 'green' : 'red'"
              class="text-white"
              v-if="HIC037.opcion_hc037"
            >
              {{ HIC037.opcion_hc037 }}
            </q-chip>
          </p>
        ...
        <div class="row" v-show="HIC037.opcion_hc037 == 'AUTORIZAR'">
          <p>
            ...
            <Input_
              style="min-width: 100%; display: inline-block"
              v-model="HIC037.procedimiento"
              :field="form.procedimiento"
            />
            cuyo objetivo es:
            <Input_
              style="min-width: 100%; display: inline-block"
              v-model="HIC037.objetivo"
              :field="form.objetivo"
            />
            diagnostico
            <Input_
