  ...
  <q-form @submit="validarDatos">
    <q-card class="q-mx-auto format q-mb-lg" style="overflow: auto">
      <q-card-section>
        ...
        <div class="row">
          <p>Fecha:</p>
          <q-input v-model="reg.fecha_act" readonly dense class="q-mr-md col-2" />
          <p>Hora:</p>
          <q-input v-model="reg.hora_act" readonly dense />
          <q-space />
          <p>Historia clínica numero:</p>
          <q-input type="text" readonly dense v-model="reg.llave" class="col-2" />
          <q-space />
        </div>
      ...
      <q-card-section>
        ...
        <div class="row" style="width: 100%">
          <div class="row" style="border: 1px solid #ccc; width: 50%">
            ...
            <Select_ class="q-mt-xs" :field="form.tipo_id" v-model="reg.tipo_id_ti" />
          </div>
          <div class="row" style="border: 1px solid #ccc; width: 50%">
            <q-input type="text" readonly label="N." dense v-model="getPaci.cod" class="col-8 q-mx-auto" />
          </div>
        </div>
        <div class="row" style="width: 100%">
          <div class="row" style="border: 1px solid #ccc; width: 50%">
          ...
          <div class="row" style="border: 0px solid #ccc; width: 50%">
            <div class="row" style="border: 1px solid #ccc; width: 100%">
              <p>Telefono:</p>
              <q-input type="text" readonly label="Telefono" dense v-model="getPaci.telefono" class="col-7" />
            </div>
            <div class="row" style="border: 1px solid #ccc; width: 50%">
              <p>CC:</p>
              <q-input
      ...
      <q-card-section>
        <div class="row">
          ...
          <q-input v-model="reg_firmador.descrip" readonly type="text" dense class="col-4" />
        ...
        <div class="row" style="margin-top: -17px">
          <p class="text-justify">
            ...
            Registro médico Nº <InputF_ v-model="getProf.cod" />
          </p>
        </div>
        <div class="row">
          <p class="text-justify" style="margin-top: -2px">
            Autorizo ESE SALUD YOPAL, para que se me practique la Interrupción Voluntaria del Embarazo (IVE)
