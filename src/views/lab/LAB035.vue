...
const datosInit = async () => {
  if (getSesion.novedad == "4") {
    ...
    Object.assign(LAB035, res_consen.value.reg_coninf.datos);
    ...
    LAB035.opcion_lab035 = "AUTORIZAR";
  ...
  LAB035.edad = calcularEdad(getAcomp.nacim);
};
