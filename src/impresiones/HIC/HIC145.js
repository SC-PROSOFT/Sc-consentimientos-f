...
export const impresionHIC145 = ({ datos }) => {
  console.log("impresionHIC145 -> ", datos);

  var dd = {
    stack: [contenidoHIC145(), firmas()],
  };
  function contenidoHIC145() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La septorrinoplastia es una técnica quirúrgica que tiene como finalidad la corrección de la forma externa de la nariz y del septum nasal que ocaciona alteración funcional.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA SEPTORRINOPLASTIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La intervención se realiza a través de unas incisiones que se hacen en el interior de las ventanas de la nariz.",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Después, los tejidos blandos se separan cuidadosamente de los cartílagos y huesos adyacentes y se corrigen las estructuras no deseadas. Posteriormente, los huesos y los cartílagos se sitúan de tal manera que tomen la forma adecuada para la nariz. Ocasionalmente puede ser necesario el uso de injertos de hueso o de cartílago. En el mismo acto quirúrgico se realiza la reconstrucción del tabique nasal, si está desviado, para aliviar la dificultad respiratoria que dicha desviación pueda producir.",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "En la intervención se deja una pequeña férula de yeso u otros materiales sobre el dorso de la nariz y se coloca un taponamiento nasal o cánulas de silicona durante unas 72 horas. Por otra parte, como quiera que la valoración del resultado de la intervención, por parte del paciente, es subjetiva, cabe la posibilidad de no resultar satisfactoria. Todas estas circunstancias podrían justificar un segundo tiempo operatorio unos meses después.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA SEPTORRINOPLASTIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          ul: [
            ...
            },
            {
              ...
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Infección local con la aparición de síntomas inflamatorios, shock tóxico estafilocóccico complicación extremadamente rara pero grave.",
            },
            {
              marginTop: 5,
              alignment: "justify",
            ...
            },
            {
              ...
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Persistencia del defecto previo a pesar de la adecuada corrección quirúrgica.",
            },
            {
              marginTop: 5,
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Sinarquías -bridas entre ambas paredes de las fosas nasales-.",
            },
            {
              marginTop: 5,
              alignment: "justify",
            ...
            },
            {
              ...
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Palpación de pequeñas excrecencias por implantación de fragmentos de hueso extirpado bajo la piel.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Ningún procedimiento invasivo está absolutamente exento de riesgos importantes, incluyendo e! de mortalidad, si bien esta posibilidad es bastante infrecuente.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { bold: true, style: "bodyNoBold9", text: "SEPTORRINOPLASTIA FUNCIONAL. \n\n" },
              {
                style: "bodyNoBold9",
