...
export const impresionHIC146 = ({ datos }) => {
  console.log("impresionHIC146 -> ", datos);

  var dd = {
    stack: [contenidoHIC146(), firmas()],
  };
  function contenidoHIC146() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La otoplastia es una cirugía correctora de la malformación del pabellón de la oreja (orejas de dumbo).",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA OTOPLASTIA: CIRUGÍA PLÁSTICA DE PABELLÓN AURICULAR",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La intervención conlleva una incisión cutánea detrás de la oreja permitiendo el trabajo a nivel de las estructuras cartilaginosas del pabellón mediante incisiones apropiadas. Posteriormente se lleva a cabo un cierre cutáneo y se coloca un vendaje compresivo.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA OTOPLASTIA: CIRUGÍA PLÁSTICA DE PABELLÓN AURICULAR",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "A pesar de la adecuada elección de la técnica y de su correcta realización, pueden presentarse efectos indeseables, tanto los comunes derivados de toda intervención y que pueden afectar a todos los órganos y sistemas, como los debidos a la situación vital del paciente (diabetes, cardiopatia, hipertensión, edad avanzada, anemia, obesidad...), y los específicos del procedimiento:",
        },
        {
          marginTop: 5,
          ul: [
            {
              ...
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Hemorragia postoperatoria que cause hematoma y requiera drenaje, revisión operatoria y vendaje compresivo largo tiempo.",
            },
            {
              marginTop: 5,
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Infección postoperatoria (dolor de la oreja y aspecto inflamatorio alrededor del pabellón auricular.",
            },
            {
              marginTop: 5,
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Si los resultados morfológicos no son muy satisfactorios, en algunos casos se puede observar irregularidades en las zonas de plicatura. Es difícil asegurar una simetría perfecta de los dos pabellones auriculares.",
            },
            {
              marginTop: 5,
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Se pueden presentar problemas sensitivos a nivel de la cicatriz sobre todo a la hora de utilización de gafas. El pabellón auricular puede quedar con menos sensibilidad en algunas semanas.",
            },
            {
              marginTop: 5,
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Condritis (infección del cartílago del pabellón de la oreja con necrosis y destrucción del cartílago del pabellón originado una deformidad importante de la oreja, con reducción del tamaño de la misma.",
            },
            {
              marginTop: 5,
              alignment: "justify",
              style: "bodyNoBold9",
              text: "La cicatriz cutánea retroauricular puede hacerse hipertrófica (queloide).",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Puede presentarse reformación de la deformidad parcial o total",
        },
        {
          marginTop: 2,
          alignment: "justify",
        ...
        { marginTop: 15, bold: true, alignment: "justify", style: "bodyNoBold9", text: "QUE OTRAS ALTERNATIVAS HAY" },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La única alternativa es la abstención terapéutico.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { bold: true, style: "bodyNoBold9", text: "OTOPLASTIA. \n\n" },
              {
                style: "bodyNoBold9",
