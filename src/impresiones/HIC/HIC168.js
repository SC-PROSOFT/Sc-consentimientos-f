...
export const impresionHIC168 = ({ datos }) => {
  console.log("impresionHIC168 -> ", datos);

  var dd = {
    stack: [contenidoHIC168(), firmas()],
  };
  function contenidoHIC168() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "En algunos casos y dependiendo del tamaño de la ránula pueden precisar sutura y/o reconstrucción con procedimientos denominados Z plastia, usualmente la técnica quirúrgica consiste en marzupializar la ránula.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA RESECCION DE RANULA",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La intervención se realiza sobre la lesión localizada en el pis anterior de la cavidad oral. La marzupializacion de la ránula permite drenar y mantener permeable el ducto salivar para controlar la acumulación de saliva.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA RESECCION DE LA RANULA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Estas complicaciones habitualmente se resuelven con tratamiento médico (medicamentos, sueros, etc.) pero pueden llegar a requerir una re intervención, en algunos casos de urgencia.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La única alternativa es la abstención terapéutica. Si después de leer detenidamente este documento desea más información, por favor, no dude en preguntar al especialista responsable, que le atenderá con mucho gusto.",
        },
        autorizaRevoca(),
      ],
    };
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { style: "bodyNoBold9", text: ", identificad@ con numero de Historia Clínica No " },
              { bold: true, style: "bodyNoBold9", text: datos.llave },
              { style: "bodyNoBold9", text: " doy mi consentimiento para que me sea realizada una " },
              { bold: true, style: "bodyNoBold9", text: " RESECCION DE RANULA. \n\n" },
              {
                style: "bodyNoBold9",
