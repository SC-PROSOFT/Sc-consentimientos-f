...
export const impresionHIC133 = ({ datos }) => {
  console.log("impresionHIC133 -> ", datos);

  var dd = {
    stack: [contenidoHIC133(), firmas()],
  };
  function contenidoHIC133() {
    return {
      stack: [
        {
          bold: true,
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { bold: true, style: "bodyNoBold9", text: "SEPTORRINOPLASTIA + TURBINOPLASTIA BILATERAL. \n\n" },
              {
                style: "bodyNoBold9",
