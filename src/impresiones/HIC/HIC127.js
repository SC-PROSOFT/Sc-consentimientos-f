...
export const impresionHIC127 = ({ datos }) => {
  console.log("impresionHIC127 -> ", datos);

  var dd = {
    stack: [contenidoHIC127(), firmas()],
  };
  function contenidoHIC127() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA AMIGDALECTOMIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA AMIGDALECTOMIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          text: [
            ...
            },
            {
              alignment: "justify",
              style: "bodyNoBold9",
              text: "Después de la cicatrización de las heridas puede observarse una modificación de la voz debido al escape del aire a nivel del velo del paladar. Excepcionalmente, es necesario una reeducación del lenguaje (logopedia). No se puede descartar la posibilidad de presentar infecciones y otitis después de la intervención, aunque habitualmente la incidenciade infecciones se reduce ostensiblemente.",
            },
          ],
        },
        {
...

        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La infección de los tejidos cervicales a través del tejido operado (flemón cervical) es raro. Los síntomas más frecuentes asociados a la infección cervical son: fiebre alta, dolor de cuello y alteraciones en su movilización. En este caso, acuda al Área de Urgencias para valoración.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { bold: true, style: "bodyNoBold9", text: "AMIGDALECTOMIA. \n\n" },
              {
                style: "bodyNoBold9",
