...
export const impresionHIC143 = ({ datos }) => {
  console.log("impresionHIC143 -> ", datos);

  var dd = {
    stack: [contenidoHIC143(), firmas()],
  };
  function contenidoHIC143() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA EXTIRPACIÓN DE LESIÓN BAJO ANESTESIA LOCAL",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Tras la infiltración con anestesia local en la zona, se extirpa la lesión (total o parcial). También cabe la posibilidad de que durante la cirugía haya que realizar modificaciones del procedimiento por los hallazgos intraoperatorios para proporcionar un tratamiento más adecuado.",
        },
        {
          marginTop: 15,
          bold: true,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA EXTIRPACIÓN DE LESIÓN BAJO ANESTESIA LOCAL",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          text: [
            ...
            },
            {
              alignment: "justify",
              style: "bodyNoBold9",
              text: "infección o hematoma de la herida quirúrgica, lesiones cutáneas por reacción alérgica a la medicación utilizada, cicatrices retráctiles o antiestéticas, molestias locales, dolor prolongado en la zona de la operación.",
            },
          ],
        },
        {
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { style: "bodyNoBold9", text: ", identificado con No historia clínica " },
              { bold: true, style: "bodyNoBold9", text: datos.llave },
              { style: "bodyNoBold9", text: ", doy mi consentimiento para que me sea realizada una " },
              { bold: true, style: "bodyNoBold9", text: "EXTIRPACIÓN DE LESIÓN BAJO ANESTESIA LOCAL. \n\n" },
              {
                style: "bodyNoBold9",
