...
export const impresionHIC032 = ({ datos }) => {
  console.log("impresionHIC032 ---> ", datos);
          ...
          [
            ...
            },
            {
              text: [
                ...
                {
                  text: `al personal asistencial de la ${datos.empresa.nomusu}, para la realización de los procedimientos de salud: ${datos.procedimiento}, cuyo objetivo es: ${datos.objetivo}, ante el diagnostico ${datos.diagnostico}`,
                },
              ],
              alignment: "justify",
              style: "bodyNoBold",
