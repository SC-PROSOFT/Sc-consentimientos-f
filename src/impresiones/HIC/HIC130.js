...
export const impresionHIC130 = ({ datos }) => {
  console.log("impresionHIC130 -> ", datos);

  var dd = {
    stack: [contenidoHIC130(), firmas()],
  };
  function contenidoHIC130() {
    return {
      stack: [
        {
          bold: true,
