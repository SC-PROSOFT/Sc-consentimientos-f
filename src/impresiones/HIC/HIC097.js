...
export const impresionHIC097 = ({ datos }) => {
  var dd = {
    stack: [contenidoHIC097(), firmas()],
  };

  function contenidoHIC097() {
    return {
      stack: [
        {
          bold: true,
          alignment: "center",
          text: "AUTORIZACIÓN  PARA  INTERVENCIÓN EN PLANIFICACIÓN FAMILIAR; INSERCIÓN O RETIRO DE DIU",
          style: "bodyNoBold9",
        },
        {
          marginTop: 15,
