...
export const impresionHIC128 = ({ datos }) => {
  console.log("impresionHIC128 -> ", datos);

  var dd = {
    stack: [contenidoHIC128(), firmas()],
  };
  function contenidoHIC128() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA TIMPANOPLASTIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA TIMPANOPLASTIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          ul: [
            ...
            },
            {
              ...
              alignment: "justify",
              style: "bodyNoBold9",
              text: "La afectación del oído interno por la otitis media crónica puede ser la causa de la persistencia de vértigos, hipoacusia y/o acufenos después de la intervención.",
            },
            {
              marginTop: 5,
              alignment: "justify",
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { bold: true, style: "bodyNoBold9", text: "TIMPANOPLASTIA. \n\n" },
              {
                style: "bodyNoBold9",
