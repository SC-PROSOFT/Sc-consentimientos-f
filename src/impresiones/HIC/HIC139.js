...
export const impresionHIC139 = ({ datos }) => {
  console.log("impresionHIC139 -> ", datos);

  var dd = {
    stack: [contenidoHIC139(), firmas()],
  };
  function contenidoHIC139() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Mediante este procedimiento se pretende extirpar y analizar nódulos sospechosos de malignidad, evitar el crecimiento excesivo de la glándula, afectación de los órganos vecinos y a distancia y/o controlar los niveles hormonales. El tipo de anestesia requerida será la indicada por el anestesiólogo. Es posible que, durante o después de la intervención, sea necesaria la utilización de sangre y/o hemoderivados. Para la realización de ésta técnica puede ser necesaria una preparación previa, aunque puede ser posible su realización sin una preparación completa. También es necesario que advierta de posibles alergias medicamentosas, alteraciones de la coagulación, enfermedades cardiopulmonares, existencia de prótesis, marcapasos, medicaciones actuales o cualquier otra circunstancia.",
        },
        {
          marginTop: 15,
          bold: true,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "EN QUE CONSISTE LA TIROIDECTOMIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Este tipo de cirugía consiste en la extirpación total o parcial de la glándula tiroides, según el tipo de afectación. En la mayoría de los casos, la extirpación produce una disminución de las hormonas necesitando tratamiento sustitutivo indefinido. A veces, el resultado definitivo de la biopsia recomienda una reintervención para extirpar el resto de la glándula.",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "RIESGOS DE LA TIROIDECTOMIA",
        },
        {
          marginTop: 5,
          alignment: "justify",
        ...
        },
        {
          ...
          text: [
            ...
            },
            {
              alignment: "justify",
              style: "bodyNoBold9",
              text: "infección, sangrado o alteraciones en la cicatrización de la herida quirúrgica, calambres y hormigueos transitorios en las manos que ceden con tratamiento, alteraciones transitorias de la deglución, alteraciones transitorias de la voz, dolor prolongado en la zona de la operación.",
            },
          ],
        },
        {
          ...
          text: [
            ...
            },
            {
              alignment: "justify",
              style: "bodyNoBold9",
              text: "hematomas importantes del cuello, alteraciones permanentes de la voz, alteraciones permanentes de las paratiroides, recidiva de la enfermedad.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "En caso de alteración hormonal, la alternativa podría ser el tratamiento médico indefinido con Yodo) . En el resto de los casos no existe alternativa terapéutica eficaz, siendo la mejor opción la cirugía.",
        },
        {
          marginTop: 5,
          alignment: "justify",
