...
export const impresionHIC118 = ({ datos }) => {
  console.log("impresionHIC118 -> ", datos);

  var dd = {
    stack: [contenidoHIC118(), firmas()],
  };
  function contenidoHIC118() {
    return {
      stack: [
        {
          alignment: "justify",
          style: "bodyNoBold9",
          text: "En este tipo de anestesio Ud. permanecerá despierto o ligeramente sedado. Es necesario también canalizar una vena antes de proceder con el bloqueo. El especialista le administrará el anestésico mediante inyección en diferentes lugares del organismo tales como la axila, la columna vertebral, etc. con la finalidad de anestesiar una determinada zona del cuerpo (un brazo, una pierna, etc.). Recuerde que en ocasiones, la anestesia regional no consigue un nivel de bloqueo suficiente y es necesario recurrir a una anestesia general. Unos electrodos adhesivos colocados en el pecho permitirán el control de su latido cardíaco.También se le colocará un aparato que medirá su tensión arterial y un dispositivo en el dedo (pulso-oxímetro) para conocer la cantidad de oxígeno en su sangre.",
        },
        {
          marginTop: 15,
          bold: true,
