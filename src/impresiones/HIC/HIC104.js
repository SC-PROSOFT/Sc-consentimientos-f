...
export const impresionHIC104 = ({ datos }) => {
  console.log("impresionHIC104 -> ", datos);

  var dd = {
    stack: [contenidoHIC104(), firmas()],
  };

  function contenidoHIC104() {
    return {
      stack: [
        {
          marginTop: 1,
          bold: true,
          style: "bodyNoBold9",
          text: "LA ESCALA PARA DESORDEN DE ANSIEDAD GENERALIZADA GAD - 2",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "La Generalized Anxiety Disorder Scale-2 (GAD-2), validada para personas mayores de 18 años, está conformada por 2 ítems que evalúan conductas vinculadas con la expresión emocional y cognitiva de la ansiedad generalizada, escalados en 5 opciones de respuesta ordinal (desde para nada hasta casi todos los días).",
        },
        {
          marginTop: 5,
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Es útil para la tamización de los trastornos de ansiedad excepto las fobias y trastorno de estrés postraumático.",
        },
        {
          marginTop: 10,
          table: {
              ...
              [
                {
                  alignment: "justify",
                  style: "bodyNoBold9",
                  text: "1. ¿Sentirse nervioso(a), ansioso(a), o inquieto?",
                },
              ...
              [
                {
                  alignment: "justify",
                  style: "bodyNoBold9",
                  text: "2. ¿No poder parar o controlar la preocupación?",
                },
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "Si la persona obtiene un puntaje mayor a 3, la tamización es positiva y se debe realizar la valoración correspondiente para confirmar un diagnóstico de ansiedad generalizada.",
        },
      ],
    };
  }
