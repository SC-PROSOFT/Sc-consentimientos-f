...
export const impresionHIC155 = ({ datos }) => {
  console.log("impresionHIC155 -> ", datos);

  var dd = {
    stack: [contenidoHIC155(), firmas()],
  };
  function contenidoHIC155() {
    return {
      stack: [
        {
          bold: true,
        ...
        },
        {
          ...
          alignment: "justify",
          style: "bodyNoBold9",
          text: "A pesar de la adecuada elección de la técnica y de su correcta realización, pueden presentarse efectos indeseables, tanto los comunes derivados de toda intervención y que pueden afectar a todos los órganos y sistemas, como los debidos a la situación vital del paciente (peso, edad, diabetes, cardiopatía.), y los específicos el procedimiento: ",
        },
        {
          marginTop: 5,
          text: [
        ...
        stack: [
          ...
          },
          {
            ...
            text: [
              ...
              { bold: true, style: "bodyNoBold9", text: " COLOCACIÓN DE TUBO EN “T” DE VENTILACIÓN OIDO " + datos.oido.trim() + ".\n\n" },
              {
                style: "bodyNoBold9",
