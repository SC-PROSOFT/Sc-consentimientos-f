<template>
  <q-card class="q-ma-xl q-pa-none q-ma-none">
    <div class="row" style="border: 1px solid #ccc">
      ...
      <div class="col-md-10">
        <div class="row">
          <div class="col-5 text-subtitle1 q-pb-xs q-pt-xs shadow-1 text-center text-bold">
            {{ datos?.DESCRIP || "Falta nombre formato" }}
          </div>
          <div class="col-3 text-subtitle1 q-pb-xs q-pt-xs shadow-1 text-center text-bold">
            <strong>VERSION {{ datos?.version }} </strong>
          </div>
          <div class="col-2 text-subtitle1 q-pb-xs q-pt-xs shadow-1 justify-center text-bold row">
        ...
        <div class="row">
          ...
          <div class="col-3 text-subtitle1 q-pb-xs q-pt-xs shadow-1 justify-center text-bold row">
...
const empresa = ref(sessionStorage.Empresa && JSON.parse(sessionStorage.Empresa));
